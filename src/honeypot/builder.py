...
from honeypot.containers.wrapper import HoneypotContainer, LOCAL_RESOURCES_DIR
...
class BackendBuilder:
    def __init__(self,
                 ...
                 resources_dir: Path | None = None) -> None:
        self._docker_client = docker_client or docker.from_env()
        self._resources_dir = resources_dir or LOCAL_RESOURCES_DIR
    ...
    def container(self, name: str = "telnet") -> ContainerBackend:
        ...
        c = HoneypotContainer(self._docker_client, ContainerConfig(name), context)
